...
def init_own(self, name, table, rml=False, parser=False,
    header=True, store=False):
    self.localcontext = {}
    report_sxw.__init__(self, name, table, rml, parser,
        header, store)

def generate_pdf_own(self, comm_path, report_xml, header, footer, html_list, webkit_header=False):
...
def translate_call_own(self, parser_instance, src):
    """Translate String."""
...
def create_single_pdf_own(self, cursor, uid, ids, data, report_xml, context=None):
    """generate the PDF"""
...
def create_own(self, cursor, uid, ids, data, context=None):
...
WebKitParser.__init__ = init_own
WebKitParser.create_single_pdf = create_single_pdf_own
WebKitParser.create = create_own
WebKitParser.generate_pdf = generate_pdf_own
WebKitParser.translate_call = translate_call_own
setattr(WebKitParser,'_sanitize_html', _sanitize_html)
